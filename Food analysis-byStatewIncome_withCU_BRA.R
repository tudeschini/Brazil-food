...
###################
  ...
  ef_crop <- xlsx::read.xlsx(paste0(datadir, "Em_factors_Narasimha_new_28feb17.xlsx"), 2, startRow=2,
                         colIndex = c(2,10), header = FALSE, stringsAsFactors=FALSE) %>% rename(item=X2, ef=X10)
  ef_lvstock <- data.frame(xlsx::read.xlsx(paste0(datadir, "Em_factors_Narasimha_new_28feb17.xlsx"), 3,
                                       colIndex = 11, header = FALSE, rowIndex=c(11:16), stringsAsFactors=FALSE),
                       xlsx::read.xlsx(paste0(datadir, "Em_factors_Narasimha_new_28feb17.xlsx"), 3,
...
########################################
  ...
  gap_threshold <- 0.0 #0.33 # 0 # 0.1 #   RDA% 
  hh_sum = hh_sum %>%
    filter(!eatout_exclude) %>%
...
##################################
  ...
  # write.csv(hh_anal_out,'../NSS_cu_diagnostics_bystate_inc_66.csv')
  # write.csv(food_group_totals,'../NSS_cu_foodgrp_diagnostics_66.csv')
  # write.csv(food_nutrients,'../NSS_cu_food_nutrients_66.csv')
  # write.csv(inc_grp_tots,'../inc_grp_cu_tots_66.csv')
  write.csv(hh_anal_out,'../NSS_cu_diagnostics_bystate_inc_95.csv')
  write.csv(food_group_totals,'../NSS_cu_foodgrp_diagnostics_95.csv')
  write.csv(food_nutrients,'../NSS_cu_food_nutrients_95.csv')
  write.csv(inc_grp_tots,'../inc_grp_cu_tots_95.csv')
  # write.csv(hh_anal_out,'../NSS_cu_diagnostics_bystate_inc_90.csv')
  # write.csv(food_group_totals,'../NSS_cu_foodgrp_diagnostics_90.csv')
  # write.csv(food_nutrients,'../NSS_cu_food_nutrients_90.csv')
  # write.csv(inc_grp_tots,'../inc_grp_cu_tots_90.csv')
  # write.csv(hh_anal_out,'../NSS_cu_diagnostics_bystate_inc_100.csv')
  # write.csv(food_group_totals,'../NSS_cu_foodgrp_diagnostics_100.csv')
  # write.csv(food_nutrients,'../NSS_cu_food_nutrients_100.csv')
  # write.csv(inc_grp_tots,'../inc_grp_cu_tots_100.csv')
...
####################  
  ...
  pdf(file = paste0(workdir, "../Figures/Share of population with iron deficiency - Rice 100.pdf"), width = 7, height = 10)
  p
  dev.off()
  ...
  pdf(file = paste0(workdir, "../Figures/Share of population with iron deficiency - Wheat 100.pdf"), width = 7, height = 10)
  p
  dev.off()
